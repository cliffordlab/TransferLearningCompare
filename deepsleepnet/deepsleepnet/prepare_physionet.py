...
def main():
    ...
    parser.add_argument("--dataFileList", type=str, default="/data/physionet_sleep",
    ...
    psg_fnames = glob.glob(os.path.join(args.dataFileList, "*PSG.edf"))
    ann_fnames = glob.glob(os.path.join(args.dataFileList, "*Hypnogram.edf"))
    psg_fnames.sort()
    ann_fnames.sort()
